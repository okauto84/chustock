"""030_EtfList.json을 sector·sectorlist별로 그룹핑해 itemcode 리스트를 저장한다."""

import json
from collections import defaultdict
from pathlib import Path

IN_FILE = Path(__file__).resolve().parents[1] / "stock" / "030_EtfList.json"
OUT_FILE = Path(__file__).resolve().parents[1] / "stock" / "031_EtfCategorization.json"
